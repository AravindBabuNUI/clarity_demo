...
const CourseEquivalency = () => {
  const [equivalencies, setEquivalencies] = useState(mockEquivalencies);
  ...
  const filteredEquivalencies = filter === 'all'
    ? equivalencies
    : equivalencies.filter(e => e.status === filter);
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="relative">
                  ...
                  <Input placeholder="Search courses..." className="pl-10 w-64 bg-background" />
                </div>
