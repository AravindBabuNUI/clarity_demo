...
// Use local worker from `pdfjs-dist` (avoids CDN 404 / fake worker warnings)
...
export function IframePDFPreview({ currentPage, totalPages, onPageChange, onTotalPagesChange }: PDFPreviewProps) {
